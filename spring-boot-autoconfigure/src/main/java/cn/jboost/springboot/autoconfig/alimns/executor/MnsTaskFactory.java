...
import cn.jboost.springboot.autoconfig.alimns.executor.task.receive.QueueReceiveTaskExecutor;
import cn.jboost.springboot.autoconfig.alimns.executor.task.receive.ReceiveTaskExecutor;
import cn.jboost.springboot.autoconfig.alimns.executor.task.send.QueueSendTask;
import cn.jboost.springboot.autoconfig.alimns.executor.task.send.TopicSendTask;
import cn.jboost.springboot.autoconfig.alimns.listener.MnsListener;
import cn.jboost.springboot.autoconfig.alimns.ResourceType;
